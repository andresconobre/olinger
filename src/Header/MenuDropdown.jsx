...
const MenuDropdown = ({ children, list }) => {
	...
	return (
		<div ref={dropdownRef} >
			...
			{isOpen && (
                <div className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 max-w-72 max-h-96 overflow-y-auto w-full mt-2 flex flex-col rounded border border-blue-olinger-c3 bg-white p-2 shadow-sm">
                    {list.map((item, index) => (
